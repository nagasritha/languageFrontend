...
class ExerciseEnglish extends Component{
    state={
        dataList:[],
        status:'loading',
        quizz:true,
    ...
    getData=async ()=>{
        ...
        const url='https://backrnd.onrender.com/questions/English';
...
submitForm=async (event)=>{
    ...
    const token=Cookies.get("jwt_token")
    const url='https://backrnd.onrender.com/correctAnswers/English';
    const options={
        method:'GET',
        headers: {
         'Authorization':`Bearer ${token}`
...
export default ExerciseEnglish